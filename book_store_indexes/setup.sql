...
\COPY customers FROM './data/customers.txt' DELIMITER ',' CSV HEADER;
\COPY books FROM './data/books.txt' DELIMITER ',' CSV HEADER;
\COPY orders FROM './data/orders.txt' DELIMITER ',' CSV HEADER;
